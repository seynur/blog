...
<p><em>Figure 1. High-level architecture overview of Apache Kafka showing the interaction between producers, brokers, and consumers.</em></p>
</div>
...
<p><em>Figure 2. Kafka topic structure showing the relationship between topics, partitions, and segments in a distributed setup.</em></p>
</div>
...
<p><em>Figure 3. Leader-follower replication model in Kafka demonstrating how data is replicated across multiple brokers for fault tolerance.</em></p>
</div>
...
<p><em>Figure 4. Internal structure of a Kafka broker showing how messages are organized in segments within partitions.</em></p>
</div>
...
<p><em>Figure 5. Kafka's log-based storage model illustrating how messages are appended sequentially in partition logs.</em></p>
</div>
...
3. [KRaft (Kafka Raft) Mode Documentation](https://kafka.apache.org/documentation/#kraft)
4. [Event Streaming with Apache Kafka](https://www.confluent.io/what-is-apache-kafka/)
